<template>
    ...
    <div class="text-lg-center font-semibold bg-sepia-300 py-5 px-5 lg:ml-10 lg:mr-10 rounded mt-20" style="text: align-center; width: 1285px; background-color: #EDC7B7">
        <p class="">It is a comprehensive, developmental program designed to assist individuals in making and implementing informed educational and occupational choices. <br>
        ...
        <br><br>Career guidance and counseling programs help individuals acquire the knowledge, skills, and experience necessary to identify options, explore alternatives and succeed in society. These programs better prepare individuals for the changing workplace of the 21st century by:

       <br> --> teaching labor market changes and complexity of the workplace
       <br> --> broadening knowledge, skills, and abilities
       <br> --> improving decision making skills
       <br> --> increasing self-esteem and motivation
       <br> --> building interpersonal effectiveness
       <br> --> maximizing career opportunities
       <br> --> improving employment marketability and opportunities
       <br> --> promoting effective job placement
       <br> --> strengthening employer relations
        </p>
    </div>
</template>
<script>
